...
**main_amount** | **number** | مجموع قیمت‌های اولیه تمام کالاها بدون تخفیف (به تومان) | [readonly] [default to undefined]
...
**discount_amount** | **number** | کل تخفیف اعمال شده بر سفارش (به تومان) | [readonly] [default to undefined]
...
**preparation_time** | **number** | زمان آمادهسازی سفارش (به روز) | [readonly] [default to undefined]
**weight** | **number** | وزن کل سفارش (بر حسب گرم) | [readonly] [default to undefined]
...
**digipay_markup_amount** | **number** | مبلغ نشانه‌گذاری برای سفارش (به تومان) | [readonly] [default to undefined]
**markup_commission_percentage** | **number** | درصد کمیسیون نشانه‌گذاری برای سفارش (به درصد) | [readonly] [default to undefined]
